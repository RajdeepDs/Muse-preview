  ...
  return (
    <div className="container flex flex-col items-center gap-y-5 ">
      <div className="mt-16 flex flex-col items-center">
        <InfoPill />
        <motion.h1
          className="my-6 text-balance bg-gradient-to-br from-white from-25% to-white/80 to-75% bg-clip-text text-center text-6xl font-bold leading-tight text-transparent"
        ...
        <motion.div
          className="text-grey/60 mb-12 text-center text-xl font-light"
